...
var permit = require('../src/index.js').tag.group('amusement', router);

console.log(permit.toString());
app.use(session({
  secret: 'keyboard cat',
  resave: false,
...
var haveFunPermission = permit('have-fun');
console.log(haveFunPermission);
